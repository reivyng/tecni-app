        ...
        <div className="container mx-auto">
          ...
          <div className="flex items-center justify-between md:hidden">            
            <div className="flex items-center space-x-4">
              ...
              className="text-[#203363] text-lg" aria-label="Facebook">
                <FaFacebook />
              </Link>
              <Link to="/contact" 
              href="https://www.instagram.com/tecniappneiva?igsh=MXNsYW54bjZzNmFpMQ=="
              className="text-[#203363] text-lg" aria-label="Instagram">
                <FaInstagram />
              </Link>
            </div>
          ...
          <div className="hidden md:flex md:items-center md:justify-between">
            <div className="flex items-center space-x-8">
              ...
              <a href="https://www.instagram.com/tecniappneiva?igsh=MXNsYW54bjZzNmFpMQ=="
               className="text-[#203363] text-lg" aria-label="Instagram">
                <FaInstagram />
              </a>
